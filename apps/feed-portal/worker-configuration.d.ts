/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 112705fb698dd3d81cb1ad2e0db94df3)
// Runtime types generated with workerd@1.20260520.1 2025-05-01 nodejs_compat
interface __BaseEnv_Env {
	SOURCE_BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	OPERATOR_ALLOWED_DOMAIN: "cloudflare.com";
	SOURCE_BUCKET_NAME: "r2-event-feed-source";
	FANOUT_BASE_URL: "https://r2-event-feed-fanout.demoflair.workers.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPERATOR_ALLOWED_DOMAIN" | "SOURCE_BUCKET_NAME" | "FANOUT_BASE_URL">> {}
}
